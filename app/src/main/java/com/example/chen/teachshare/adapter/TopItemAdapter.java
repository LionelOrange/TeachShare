...
import com.example.chen.teachshare.bean.TopItem;
...
public class TopItemAdapter extends android.support.v4.view.PagerAdapter {
    ...
    private void initData() {
        ...
        imageSource.add(new TopItem(R.drawable.top11, "我所经历的生活", "4月18日 周六"));
        imageSource.add(new TopItem(R.drawable.top22, "橡皮擦初心", "4月18日 周六"));
        imageSource.add(new TopItem(R.drawable.top33, "一只喵的幸福生活", "4月17日 周五"));
        imageSource.add(new TopItem(R.drawable.top44, "手绘电影场景", "4月16日 周四"));
    }
